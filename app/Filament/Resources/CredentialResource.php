            ...
            ->columns([
                TextColumn::make('name')
                    ...
                    ->description(function (Credential $record): HtmlString {
                        ...
                        $isOk = $record->status === CredentialStatus::Ok;
                        $statusColor = $isOk ? '#22c55e' : '#ef4444';
                        $statusShortLabel = $isOk ? __('credential.status.ok_short') : __('credential.status.fail_short');
                        $statusTooltip = $record->last_error ? $record->last_error : '';
                        ...
                        $statusIcon = $isOk ? $checkIcon : $xIcon;
